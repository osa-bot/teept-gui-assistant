# Contributing to teept-gui-assistant

We welcome you to [check the existing issues](https://github.com/andreygetmanov/teept-gui-assistant/issues) for bugs or enhancements to work on.
If you have an idea for an extension to teept-gui-assistant, please [file a new issue](https://github.com/andreygetmanov/teept-gui-assistant/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/andreygetmanov/teept-gui-assistant/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/teept-gui-assistant.git
   ```
...
Finally, go to the web page of your fork of the teept-gui-assistant repo, and click
...
If your contribution changes teept-gui-assistant in any way:

- Update the [README](https://github.com/andreygetmanov/teept-gui-assistant/tree/main/README.md) if anything there has changed.
